...
import { Modal, View, Text, TouchableOpacity, StyleSheet, Image, Pressable, Animated } from 'react-native';
        ...
        <Modal transparent={true} animationType="fade" visible={true}>
            <View style={styles.overlay}>
                <View style={styles.modalContainer}>
                    <Image source={require('../assets/icons/sadIcon.png')} style={{ width: wp(18), height: hp(8) }} resizeMode='contain' />
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                        ...
                        <Pressable onPress={ViewAds} style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: 'green', paddingHorizontal: 6, borderRadius: 8 }}>
